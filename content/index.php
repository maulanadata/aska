...
<section id="collection" class="py-5">
    <div class="container">
        <div class="title text-center">
          <h2 class="position-relative d-inline-block mb-4">3 Thread Terpopuler </h2>
        </div>
        ...
        <div class="row g-0">
            <div class="d-flex flex-wrap justify-content-center mb-3 filter-button-group">
                ...
                <button type="button" class="btn m-2 text-dark" data-filter=".internet">
                Internet
                </button>
                <button type="button" class="btn m-2 text-dark" data-filter=".beauty">
                Beauty
                </button>
                <button type="button" class="btn m-2 text-dark" data-filter=".games">
                Games
                </button>
                <button type="button" class="btn m-2 text-dark" data-filter=".photography">
                Photography
                </button>
            </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="media col-8 align-items-center"> 
                                        ...
                                        <div class="media-body flex-truncate ml-2">
                                            ...
                                            <a href="javascript:void(0)" class="text-muted small text-truncate" data-abc="true">by Tim cook</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body py-3 games">
                        <div class="row no-gutters align-items-center" style="width:1100px;">
                            <div class="col">
                                ...
                                <div class="text-muted small mt-1">Started 5 days ago &nbsp;·&nbsp; 
                                    <a href="javascript:void(0)" class="text-muted" data-abc="true"
                                    >Games</a>
                                </div>
                            </div>
                            <div class="d-none d-md-block col-4">
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="media col-8 align-items-center"> 
                                        ...
                                        <div class="media-body flex-truncate ml-2">
                                            <div class="line-height-1 text-truncate">1 day ago</div> 
                                            <a href="javascript:void(0)" class="text-muted small text-truncate" data-abc="true"
                                            >by Steve smith</a>
                                        </div>
                                    </div>
                                </div>
...
<!-- <script src="http://localhost/aska/assets/custom/script.js"></script> -->
